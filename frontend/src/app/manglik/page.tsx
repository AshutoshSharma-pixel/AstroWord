        ...
        <div className="min-h-[100dvh] bg-bg text-text py-12">
            ...
            <div className="max-w-2xl mx-auto px-4 pb-16 space-y-8 mt-12 border-t border-border/30 pt-12">
                <div className="space-y-4">
                    ...
                    <p className="text-muted text-sm leading-relaxed">
                        Manglik Dosha (also known as Kuja Dosha or Chevvai Dosham) is one of the most discussed concepts in Vedic astrology.
                        It occurs when Mars (Mangal) is placed in certain houses of a person's birth chart (Lagna Kundali).
                        Mars is a fiery planet representing energy, passion, and aggression. When placed in houses associated with marriage and harmony, it can create challenges.
                    </p>
                    <p className="text-muted text-sm leading-relaxed">
                        However, Vedic astrology also provides numerous cancellation rules (Bhanga) that can reduce or completely nullify the effects of Manglik Dosha.
                        AstroWord calculates both the presence of the dosha and all possible cancellation factors to give you an accurate picture.
                    </p>
                </div>
                <div className="space-y-4">
                    <h2 className="text-gold font-serif text-2xl">How is Manglik Dosha Calculated?</h2>
                    <p className="text-muted text-sm leading-relaxed">
                        Traditionally, Manglik Dosha is checked from the Ascendant (Lagna). If Mars is in the 1st, 4th, 7th, 8th, or 12th house from the Ascendant, the person is considered Manglik.
                        Some traditions also check it from the Moon and Venus.
                        AstroWord focuses on the primary Lagna chart calculation and applies classic cancellation rules such as Mars in its own sign, exalted sign, or aspected by beneficial planets like Jupiter.
                    </p>
                </div>
            </div>
        </div>

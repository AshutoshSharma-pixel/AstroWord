...
from api import chart, ask, payment, karaka, gana, user, marriage, marriage_report, manglik, daily_transit, dasha, tithi, upapada, arudha, kaal_sarp, sade_sati, moon_sign, nakshatra, lagna, ishta_devata, pitra_dosha, d9_chart, raja_yoga, kundali_matching, kundali_matching_report
...
app.include_router(tithi.router, prefix="/api")
app.include_router(daily_transit.router, prefix="/api")
app.include_router(upapada.router, prefix="/api")
...
app.include_router(d9_chart.router, prefix="/api")
app.include_router(raja_yoga.router, prefix="/api")
app.include_router(kundali_matching.router, prefix="/api")
app.include_router(kundali_matching_report.router, prefix="/api")
